...
from lib.common import add_path, env, rdict, cv2_wait, cv2_putText, is_py3

if is_py3:
    import pickle
else:
    import cPickle as pickle
from lib.imagedata_lmdb import ImageData_lmdb
...
class Dataset_Base(Dataset):
    ...
    def __init__(self, base_dir, category, collection='train', net_arch='alexnet', sampling=1.0, sample_inds=None):
        ...
        # get im_db
        self.db_path = os.path.join(base_dir, 'ModelNet10-SO3', 'ModelNet10-SO3', self.collection2dbname[collection])
